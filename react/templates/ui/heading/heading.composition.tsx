...
export const H4Heading = () => <Heading tag="h4">H4 Heading</Heading>;

export const H5Heading = () => <Heading tag="h5">H5 Heading</Heading>;

export const H6Heading = () => <Heading tag="h6">H6 Heading</Heading>;
